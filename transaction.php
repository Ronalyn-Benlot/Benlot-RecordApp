...
<?php
    ...
    //determine the sql LIMMIT starting number for the results on the display page
    $page_first_result = ($page-1) * $results_per_page; 
    //create query
    if (strlen($search) > 0){
        $query ='SELECT transaction.datelog, transaction.documentcode, transaction.action, office.name as office_name, CONCAT(employee.lastname,",", employee.firstname) as employee_fullname, transaction.remarks FROM recordsapp.employee, recordsapp.office, recordsapp.transaction  
